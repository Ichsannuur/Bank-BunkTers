...
<title><s:text name="title.skncredit"/></title>
</head>
<body>
                        <div class="main-body">
                            <!-- BASIC INPUT -->
                            ...
                            <div class="widget">
                                <div class="widget-header">
                                    <h3><i class="fa fa-credit-card fa-fw"></i><s:text name="title.skncredit"/></h3> <em> - <a href="http://www.banknagari.co.id" target="_blank">Bank Nagari Padang</a> Bersama Membina Citra Membangun Negeri</em>
                                </div>
