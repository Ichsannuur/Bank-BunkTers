...
<title><s:text name="title.overbooking"/></title>
</head>
<body>						
						<div class="main-body">
							<!-- BASIC INPUT -->
							...
							<form method="post">
										...
										<div class="widget">
											<div class="widget-header">
												<h3><i class="fa fa-credit-card fa-fw"></i><s:text name="title.overbooking"/></h3> <em> - <a href="http://www.banknagari.co.id" target="_blank">Bank Nagari Padang</a> Bersama Membina Citra Membangun Negeri</em>
											</div>
											<div class="widget-content">
												<div class="form-horizontal">
													...
													<div class="form-group">
														<label class="col-md-2 control-label"><s:text name="form.fromtoaccount"/></label>
														<div class="col-md-4">
															<input type="text" class="form-control" />
														</div>
														<label class="col-md-2 control-label"><s:text name="form.fromtotransactioncode"/></label>
														<div class="col-md-4">
															<input type="text" class="form-control" />
														</div>
													</div>
