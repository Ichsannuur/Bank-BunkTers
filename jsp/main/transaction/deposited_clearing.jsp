...
<title><s:text name="title.depositedclearing" /></title>
</head>
<body>
						<div class="main-body">
							<!-- BASIC INPUT -->
									<form method="post">
										<div class="widget">
											<div class="widget-header">
												<h3><i class="fa fa-credit-card fa-fw"></i><s:text name="title.depositedclearing" /></h3> <em> - <a href="http://www.banknagari.co.id" target="_blank">Bank Nagari Padang</a> Bersama Membina Citra Membangun Negeri</em>
											</div>
											<div class="widget-content">
												<div class="form-horizontal">
													...
													<div class="form-group">
														...
														<label class="col-md-2 control-label"><s:text name="form.totalsheetchecks" /></label>
														<div class="col-md-4">
															<input type="number" class="form-control" />
														</div>
													</div>
